      ...
      <div class="settings-sections">
        ...
        <div class="settings-section">
          ...
          <div class="setting-item">
            <label for="api-key">百度千帆API密钥</label>
            <input 
              id="api-key"
              v-model="apiKey"
              type="password"
              ...
              class="setting-input"
            />
            <p class="setting-hint">用于访问百度千帆AI服务，请妥善保管</p>
        ...
        <div class="settings-section">
          <h3>无人机默认参数</h3>
          <div class="setting-item">
            <label for="default-radius">默认巡逻半径 (米)</label>
            <input 
              id="default-radius"
              ...
              class="setting-input"
            />
            <p class="setting-hint">无人机单次巡逻的覆盖范围</p>
          </div>
          ...
          <div class="setting-item">
            <label for="default-start">默认起点坐标 (x,y)</label>
            <input 
              id="default-start"
              ...
              class="setting-input"
            />
            <p class="setting-hint">无人机巡逻的起始位置</p>
          </div>
        </div>
        ...
        <div class="settings-section">
          ...
          <div class="setting-item">
            ...
            <div class="system-info">
              ...
              <span class="storage-text">{{ storageUsed }}% 已使用 ({{ usedSpace }} MB / {{ totalSpace }} MB)</span>
            </div>
          </div>
        </div>
...
const defaultStartPoint = ref('100,200')
...
const loadSettings = () => {
  ...
  if (savedDroneParams) {
    try {
      ...
      defaultRadius.value = params.patrolRadius || 1000
      defaultGrid.value = params.gridBlocks || '4 * 4'
      defaultStartPoint.value = params.startPoint || '100,200'
    } catch (error) {
...
const saveSettings = () => {
  ...
  const droneParams = {
    patrolRadius: defaultRadius.value,
...
const resetSettings = () => {
  if (confirm('确定要恢复默认设置吗？当前设置将会被覆盖。')) {
    ...
    // 重置无人机参数
    defaultRadius.value = 1000
    defaultGrid.value = '4 * 4'
    defaultStartPoint.value = '100,200'
