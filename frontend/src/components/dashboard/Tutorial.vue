        ...
        <div v-if="activeSection === 'getting-started'" class="tutorial-section">
          ...
          <div class="tutorial-steps">
            ...
            <div class="step">
              ...
              <div class="step-content">
                <h4>设置无人机参数</h4>
                <p>配置巡逻半径、起点块和网格分区数量。系统将根据这些参数规划巡逻路径。</p>
              </div>
            </div>
            ...
            <div class="step">
              ...
              <div class="step-content">
                <h4>开始分析</h4>
                <p>
                  点击"开始智能分析"按钮，系统将自动分析地形威胁度并生成巡逻路径。分析时间约2-5分钟，具体时间与您设定的分块数量有关。
                </p>
              </div>
            </div>
            ...
            <div class="step">
              ...
              <div class="step-content">
                <h4>查看结果</h4>
                <p>
                  在右侧面板中查看热力图、巡逻路径和分析统计信息。可以下载结果并在统计信息板块查看详细信息。
                </p>
              </div>
            </div>
          </div>
        ...
        <div v-if="activeSection === 'map-analysis'" class="tutorial-section">
          ...
          <div class="feature-grid">
            <div class="feature-card">
              ...
              <h4>网格分区</h4>
              <p>将地图划分为 M×N 个区块，便于分区巡逻和管理。点击区块可以查看详细信息。</p>
            </div>
            ...
            <div class="feature-card">
              ...
              <h4>威胁度分析</h4>
              <p>
                基于我们独创的AI分析+威胁度计算模型分析地形威胁度，生成热力图。红色表示高威胁区域，绿色表示低威胁区域。
              </p>
            </div>
            ...
            <div class="feature-card">
              ...
              <h4>路径规划</h4>
              <p>
                自动根据评估结果生成最优巡逻路径，帮助排查高威胁区域，确保无人机巡逻安全和高效。
              </p>
            </div>
            ...
            <div class="feature-card">
              <div class="feature-icon">📊</div>
              <h4>统计分析</h4>
              <p>提供详细的统计数据，包括分析时间、巡逻点判定和统计等。</p>
            </div>
          </div>
        </div>
        ...
        <div v-if="activeSection === 'drone-params'" class="tutorial-section">
          ...
          <div class="param-guide">
            <div class="param-item">
              <h4>分析名称</h4>
              <p>
                为您的分析设置一个名称，方便您在后续查看和管理。若没有设置，默认使用输入图片文件名。
              </p>
              <p class="param-hint">一般建议您自行设置以帮助您能更好地查找和管理您的分析结果。</p>
            </div>

            <div class="param-item">
              <h4>巡逻起点区块</h4>
              <p>
                无人机巡逻的起始位置区块。格式为"x,y"，例如"0,0"。我们会在视图上显示区块分划以帮助您定位。
              </p>
...
const faqs = ref<FAQ[]>([
  ...
  },
  {
    ...
    question: '系统对硬件有什么要求？',
    answer:
      '推荐使用现代浏览器（Chrome 90+、Firefox 88+、Safari 14+），需要网络连接以调用 API 服务。',
  },
  {
    id: 5,
    question: '数据安全如何保障？',
    answer:
      '所有上传的地图数据和分析结果都存储在本地，不会上传到服务器。API 调用通过 HTTPS 加密传输。',
  },
])
