        ...
        <div class="help-section">
          ...
          <div class="section-content">
            <div class="contact-info">
              ...
              <div class="contact-item">
                <h3>源码资源</h3>
                <p><strong>GitHub 仓库：</strong>https://github.com/SW0rds233/my_web</p>
              </div>
...
const faqs = ref([
  ...
  },
  {
    ...
    answer:
      '巡逻半径建议设置为 500-2000 米，根据实际巡逻范围调整。网格分区数量建议为 4×4 到 8×8，分区越多分析越精细但耗时越长。起点坐标建议设置在易于起飞的位置。',
  },
  {
    id: 7,
    question: '分析需要多长时间？',
    answer:
      '分析时间取决于地图大小、网格分区数量和网络状况。通常 1000×1000 像素的地图分析需要 1 分钟左右。如果分析时间过长，可以尝试减小地图尺寸或减少网格分区。',
  },
  {
    id: 8,
  ...
  },
  {
    ...
    question: '如何备份我的工作？',
    answer:
      '建议定期导出分析结果进行备份。您也可以在系统设置中启用"自动保存"功能，系统会在您工作时自动保存进度。',
  },
  {
    id: 10,
    question: '遇到问题如何获得帮助？',
