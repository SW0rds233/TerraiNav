          ...
          <div class="section-content">
            <div class="troubleshooting-list">
              <div class="trouble-item">
                <h3>地图瓦片加载失败</h3>
                <p><strong>可能原因：</strong>网络连接不稳定、瓦片服务暂时不可用</p>
                <p>
                  <strong>解决方法：</strong>检查网络连接，刷新页面重试，或切换地图图层
                </p>
              </div>
          ...
          <div class="section-content">
            <div class="practice-list">
              <div class="practice-item">
                <h3>地图区域选择建议</h3>
                <ul>
                  <li>使用地名搜索或经纬度输入精确定位目标区域</li>
                  <li>调整缩放级别控制分析精度（zoom 14-17 较合适）</li>
                  <li>选择地形特征明显的区域（山地、水域、建筑混合）</li>
                  <li>确保目标区域完全可见后再开始分析</li>
                </ul>
              </div>
...
const faqs = ref([
  ...
  },
  {
    ...
    question: '数据是否安全？',
    answer:
      '所有选择的地图区域数据和分析结果存储在本地，不会上传到服务器。API 调用通过 HTTPS 加密传输。',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    answer:
      '目前系统支持单任务分析。您需要完成当前区域的分析后，才能选择和分析下一个区域。分析结果可在"历史记录"中查看。',
  },
  {
    id: 9,
    question: '如何备份我的工作？',
